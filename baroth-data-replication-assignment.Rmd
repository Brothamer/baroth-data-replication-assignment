...
3. Figure replication
   ...
   + Suggest a boxplot as an alternative
...
* Install: {tidyverse}, {distributions3}, {ggpubr}, {lme4}, {Matrix}
...
### 1b) Check for Normal Distribution

n < 30, so it is appropriate to check if the data is normally distributed. 
...
### 2b) Check for Normal Distribution

### 2c) Confidence intervals of the mean difference
```{r}
...
### 2d) Paired-Samples, One-Tailed T-test
